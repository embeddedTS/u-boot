 ...
 */
#ifndef __CONFIGS_TS7400V2_H__
#define __CONFIGS_TS7400V2_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcboot=echo Booting from the onboard eMMC  ...; " \
		...
		"load mmc 1:2 ${fdtaddr} /boot/imx28-ts7400v2.dtb; " \
	...
	"nfsboot=echo Booting from NFS ...; " \
		...
		"nfs ${fdtaddr} ${nfsroot}/boot/imx28-ts7400v2.dtb; " \
		"bootm ${loadaddr} - ${fdtaddr};\0"\
