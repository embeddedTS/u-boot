 ...
 */
#ifndef __CONFIGS_TS7400_V2_H__
#define __CONFIGS_TS7400_V2_H__
...
#define CONFIG_TECHNOLOGIC_WATCHDOG
#define CONFIG_WATCHDOG_TSWDOG_BUS	0
#define CONFIG_WATCHDOG_TSWDOG_ADDR	0x78
