 ...
 *
 * Sage config, based on TS-7680
 * Based on m28evk.h
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */
#ifndef __CONFIGS_SAGE_H__
#define __CONFIGS_SAGE_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcboot=echo Booting from the onboard eMMC  ...; " \
		...
		"load mmc 1:2 ${fdtaddr} /boot/imx28-tssage.dtb; " \
	...
	"sdboot=echo Booting from the SD Card ...; " \
		...
		"load mmc 0:2 ${fdtaddr} /boot/imx28-tssage.dtb; " \
	...
	"nfsboot=echo Booting from NFS ...; " \
		...
		"nfs ${fdtaddr} ${nfsroot}/boot/imx28-tssage.dtb; " \
		"mx28_prod 3;" \
		"bootm ${loadaddr} - ${fdtaddr};\0"\
