...
int do_ice40_load(void)
{
	...
	/* This is on bus 1, but, not on a real CS. We need to use a GPIO for
	 * CS so we can manually control it as needed for programming.
	 */
	fpga_dev = spi_setup_slave(1, 0, 25000000, SPI_MODE_3);
