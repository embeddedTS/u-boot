...
/*
 * Parses strap configurations on a TS-4900 across all PCB revisions, and
 * normalizes them to a consistent meaning across all hardware revisions
 ...
 *     GPIO bank in this context is the hardware, 1 indexed, number
 ...
 *
 * The RAM configuration meanings have been normalized since Rev. D with
 * Rev. E sharing the same meanings.
 */
