...
/* This uses GPIO mode for chipselect since the actual devicetree does as well.
 */
...
static int fpga_program(void)
{
	...
	/* Enable ECSPI2 clock for FPGA SPI bus */
...
static const int ts4900s_1000mhz_2x256mx16_dcd_table[] = {
	...
	0x020e048c, 0x00000030,
	0x021b0800, 0xa1390003,
	0x021b080c, 0x00560056,
	0x021b0810, 0x004b0056,
	0x021b480c, 0x001F001F,
	0x021b4810, 0x001F001F,
	0x021b083c, 0x4252024f,
	0x021b0840, 0x023d023c,
	0x021b483c, 0x4201020C,
	0x021b4840, 0x01660172,
	0x021b0848, 0x42444a48,
	0x021b4848, 0x4A4F5049,
	0x021b0850, 0x34302a30,
	0x021b4850, 0x3238372B,
	0x021b081c, 0x33333333,
	0x021b0820, 0x33333333,
	0x021b0824, 0x33333333,
...
static const int ts4900s_800mhz_2x256mx16_dcd_table[] = {
	...
	0x020e048c, 0x00000030,
	0x021b0800, 0xa1390003,
	0x021b080c, 0x004b004d,
	0x021b0810, 0x0040004b,
	0x021b480c, 0x001F001F,
	0x021b4810, 0x001F001F,
	0x021b083c, 0x424e024f,
	0x021b0840, 0x02340234,
	0x021b483c, 0x4201020C,
	0x021b4840, 0x01660172,
	0x021b0848, 0x46474a48,
	0x021b4848, 0x4A4F5049,
	0x021b0850, 0x36322c33,
	0x021b4850, 0x3238372B,
	0x021b081c, 0x33333333,
	0x021b0820, 0x33333333,
	0x021b0824, 0x33333333,
...
void board_init_f(ulong dummy)
{
	...
	/* Set up CPU strap pads for later */
	...
	if (fpga_program() < 0) {
		puts("FPGA Programming failed; ensure valid bitstream in SPI NOR!\n");
		mdelay(100);
		reset_cpu();
	}

	/* Re-enable RTC power */
	gpio_direction_input(rtc_gpio[1].gpio);
	gpio_direction_input(rtc_gpio[2].gpio);
	/* The early disabling of the RTC power means that it was low for a long
	 * time during FPGA programming, so we don't need any pre-enable delay.
	 * However, we still need some post-enable delay in order to ensure that
	 * the RTC will respond and the bus is in a stable state.
	 */
	rtc_enable(rtc_gpio[0], 0, 90000);
	...
	/* At this point, we should be able to talk to the FPGA and get
	 * strap pins from the FPGA.
	 */
